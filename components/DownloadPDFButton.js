...
const DownloadPDFButton = ({ data, language }) => {
  ...
  return (
    <button 
      ...
      disabled={isLoading}
      className={` ${styles.button} | w-full flex justify-center items-center gap-2 whitespace-nowrap rounded bg-black font-medium text-white tracking-wide p-4 disabled:opacity-50 disabled:cursor-not-allowed`}
    >
