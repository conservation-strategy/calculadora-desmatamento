        ...
        <TableBody>
          {rows.map((row) => (
            ...
            >
              ...
              <TableCell align="right" sx={{ p: 2.5, whiteSpace: 'nowrap', fontSize: '0.8rem', '@media(min-width: 430px)': { fontSize: '1.1rem' }, borderColor: 'rgba(0, 0, 0, 0.3)' }}>
                {formatCurrencyNoDecimals(currency, row.cost / exchangeRate)}
              </TableCell>
            </TableRow>
          ))}
        </TableBody>
